                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        {!isOwnReview ? (
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-navy px-3 py-2 text-xs font-bold text-white transition hover:bg-ocean"
                          >
