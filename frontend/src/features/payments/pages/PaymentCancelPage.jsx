    ...
    <main className="min-h-screen bg-[#071d32]">
      <PageContainer size="content" className="py-10 md:py-14">
        <div className="rounded-[32px] border border-gold/20 bg-navy p-6 text-white shadow-soft md:p-8">
          <div className="flex h-14 w-14 items-center justify-center rounded-3xl bg-red-500/15 text-red-100 ring-1 ring-red-400/40">
          ...
          <p className="mt-4 text-sm leading-7 text-white/70 md:text-base">
            No payment was completed. Your booking is only confirmed after payment succeeds.
            You can return to the booking and try again while the payment window is still open.
          </p>
