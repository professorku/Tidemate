  ...
  return (
    <PageContainer size="auth" className="py-8 md:py-10" contentClassName="space-y-0">
      <div className="rounded-[20px] bg-white p-5 shadow-soft md:p-6">
        <h1 className="mb-1 text-2xl font-extrabold text-slate-900">Reset password</h1>
        <p className="mb-5 text-sm text-slate-600">Choose a new password for your TideMate account.</p>
        ...
        {!hasValidParams ? (
          <p className="mt-4 text-sm text-red-600">This reset link is incomplete. Request a new one below.</p>
        ) : null}
